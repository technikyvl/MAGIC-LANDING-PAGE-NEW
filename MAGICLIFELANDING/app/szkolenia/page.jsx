        ...
        <div className={CONTAINER + " text-center flex flex-col items-center justify-center min-h-[80vh] relative"}>
          ...
          <div className="relative z-10">
            ...
            <div className="hero-reveal mt-12 flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6">
              ...
              <a href="https://wa.me/48602200511" className="group rounded-2xl border-2 border-neutral-300 px-6 py-4 sm:px-10 sm:py-5 font-semibold text-neutral-900 hover:border-accent hover:text-accent hover:bg-accent/5 transition-all duration-300 hover:scale-105 w-full sm:w-auto text-center">
