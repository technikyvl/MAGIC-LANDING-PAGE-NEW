        ...
        <div className={CONTAINER}>
          ...
          <div className="mt-12 grid gap-6 sm:grid-cols-3">
            {[
              ...
              ['Anna W.', '„Nie wierzyłem, że ktokolwiek mi pomoże. Alkohol był moim sposobem na życie, na radzenie sobie z emocjami. Sesje uświadomiły mi, skąd bierze się ten mechanizm, i krok po kroku odzyskałem siebie. Dziś jestem trzeźwy, czuję się wolny, a moje relacje z bliskimi odżyły. To było jak powrót do życia, którego nigdy nie znałem."'],
              ['Piotr L.', '„Od zawsze marzyłam o własnym domu, ale to marzenie wydawało się odległe i nierealne. Praca nad sobą pozwoliła mi zrozumieć, jak bardzo blokowałam swoje pragnienia. Zmieniłam sposób myślenia, zaczęłam podejmować inne decyzje i… dziś mieszkam w moim wymarzonym domu. Co więcej, awansowałam na stanowisko, o którym wcześniej nawet nie marzyłam. Ta transformacja zmieniła całe moje życie."'],
            ].map(([name, text], i) => (
        ...
        <div className={CONTAINER + " text-center"}>
          <div className="slow-reveal mx-auto max-w-4xl">
            ...
            <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <a href="https://wa.me/48602200511" className="group rounded-2xl border-2 border-neutral-300 px-8 py-4 font-semibold text-neutral-700 transition-all duration-300 hover:border-accent hover:text-accent hover:bg-accent/5 hover:scale-105">
